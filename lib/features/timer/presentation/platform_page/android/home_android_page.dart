...
import 'package:cube_timer_oficial/shared/widgets/appbar/appbar_home.dart';
...
class TimerAndroidPage extends ConsumerStatefulWidget {
  final CubeType selectedCubeType;
  const TimerAndroidPage({super.key, required this.selectedCubeType});
  // final scaffoldKey = GlobalKey<ScaffoldState>();

  @override
  ConsumerState<TimerAndroidPage> createState() => _TimerAndroidPageState();
}

class _TimerAndroidPageState extends ConsumerState<TimerAndroidPage> {
  int indexPage = 0;
